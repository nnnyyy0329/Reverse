...
void InteriorPlayer::GetAttackConfigs(AttackConfig configs[3])
{
	...
	configs[0] = {{0.0f, 80.0f, 40.0f}, {0.0f, 120.0f, 0.0f}, 4.0f};	// 第1攻撃
	configs[1] = {{0.0f, 20.0f, 30.0f}, {0.0f, 100.0f, 0.0f}, 4.0f};	// 第2攻撃
	configs[2] = {{0.0f, 150.0f, 35.0f}, {0.0f, 80.0f, 0.0f}, 15.0f};	// 第3攻撃
}