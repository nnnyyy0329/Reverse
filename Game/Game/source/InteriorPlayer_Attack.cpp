...
// 攻撃コリジョンの設定
void InteriorPlayer::InitializeAttackData()
{
	// 第1攻撃：カプセル攻撃
...
// コリジョン位置の更新関数
void InteriorPlayer::ProcessAttackColPos()
{
...
// 攻撃Process呼び出し用関数
void InteriorPlayer::CallProcessAttack()
{
	// 攻撃処理
	ProcessAttack();
...
// 攻撃処理
void InteriorPlayer::ProcessAttack()
{
	// 攻撃入力チェック（通常状態時）
...
// 攻撃分岐処理
void InteriorPlayer::ProcessBranchAttack()
{
	// 現在の状態に応じて攻撃処理を分岐
...
// 1段目の攻撃
void InteriorPlayer::ProcessFirstAttack()
{
	// 第1攻撃の状態更新
...
// 2段目の攻撃
void InteriorPlayer::ProcessSecondAttack()
{
	// 第2攻撃の状態更新
...
// 3段目の攻撃
void InteriorPlayer::ProcessThirdAttack()
{
	// 第3攻撃の状態更新
...
// 攻撃コリジョンの情報受け取り用関数
void InteriorPlayer::ReceiveAttackColData()
{
	// 攻撃のコリジョン情報を取得
...
// 次の攻撃が可能かチェック
bool InteriorPlayer::CanNextAttack()
{
...
// 攻撃状態中かどうかをチェック
bool InteriorPlayer::IsAttacking()
{
